		...
		tv.ouya.console.api.OuyaResponseListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Ouya.Console.Api.StringListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", StringListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == StringListener.class)
			mono.android.TypeManager.Activate ("Ouya.Console.Api.StringListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
