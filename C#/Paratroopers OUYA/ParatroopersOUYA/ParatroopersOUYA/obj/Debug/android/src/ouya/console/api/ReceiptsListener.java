		...
		tv.ouya.console.api.OuyaResponseListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Ouya.Console.Api.ReceiptsListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", ReceiptsListener.class, __md_methods);
	}


	public ReceiptsListener ()
	{
		super ();
		if (getClass () == ReceiptsListener.class)
			mono.android.TypeManager.Activate ("Ouya.Console.Api.ReceiptsListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
