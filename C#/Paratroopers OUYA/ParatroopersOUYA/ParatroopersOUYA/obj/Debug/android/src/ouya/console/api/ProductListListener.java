		...
		tv.ouya.console.api.OuyaResponseListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Ouya.Console.Api.ProductListListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", ProductListListener.class, __md_methods);
	}
	...
	public ProductListListener ()
	{
		...
		if (getClass () == ProductListListener.class)
			mono.android.TypeManager.Activate ("Ouya.Console.Api.ProductListListener, Ouya.Console.Api, Version=1.0.4.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
