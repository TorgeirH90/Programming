...
namespace KSCW
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            LoadCont.Load(ref spriteBatch, GraphicsDevice, Content);
            G.Utedo = Content.Load<Texture2D>("Content/utedo_map");
            
            //G.myModel = Content.Load <Model> (TitleContainer.OpenStream("Content/Wedge/Wedge.fbx").;
